package com.mycompany.batallanaval.Barcos;
...
public class Buque implements interfazBarco {
	...
	public Buque(boolean direccion){
	...
	public String toString() {
		return "Buque [TAMANIO=" + TAMANIO + ", direccion=" + direccion
